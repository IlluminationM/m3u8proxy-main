...
import { proxyRequest, onProxyResponse } from "./proxyRequest.js";
...
export default function getHandler(options, proxy) {
  ...
  return function (req, res) {
    ...
    const rateLimitMessage =
      corsAnywhere.checkRateLimit && corsAnywhere.checkRateLimit(req.headers.origin || "");
    if (rateLimitMessage) {
      res.writeHead(429, "Too Many Requests", cors_headers);
      res.end(
        'This origin has sent too many requests.\n' +
          rateLimitMessage
      );
      return;
    }
